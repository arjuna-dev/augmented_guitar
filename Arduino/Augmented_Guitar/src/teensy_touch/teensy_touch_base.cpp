...
TeensyTouchBase::TeensyTouchBase(int pins_array[], int pins_array_size, int touch_values_array[], int touch_values_array_size){
...
int TeensyTouchBase::teensyTouchReturn() {
  delayMicroseconds(1);
  return TSI0_DATA & 0xFFFF;
}

int TeensyTouchBase::teensyTouchInit(int pin) {
  uint32_t ch;
...
int TeensyTouchBase::teensyTouchDone() {
